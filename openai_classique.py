...
df_examples = pd.DataFrame(
    ...
    data=[
        ['Créer une liste de mots-clés', 'Liste 10 mots-clés en rapport avec le vin et les caves à vin', 'Génération de contenu'],
        ['Générer des idées/Brainstorming', 'Brainstorm des idées de contenu en rapport avec le vin et les caves à vin', 'Génération de contenu'],
        ['Générer une FAQ', 'Crée une liste de 10 questions fréquemment posées sur les caves à vin', 'Génération de contenu'],
        ['Utiliser un langage plus ou moins soutenu', 'Ecrit un texte comme un humain à propos des caves à vins', 'Génération de contenu'],
        ['Générer une structure de texte/Générer le plan d\'un article', 'Crée un plan de dissertation en rapport avec les caves à vin et leurs détails techniques', 'Génération de contenu'],
        ['Générer un texte à partir de mots/phrases clé(e)s', 'Ecrit un texte en rapport avec les caves à vin en te basant sur ces mots-clés : cave, vin, température, humidité, Ma Cave à Vin, blog, passion, etc.', 'Génération de contenu'],
        ['Extraire des mots-clés', 'Extrait les mots clés de ce texte : [entrer un texte]', 'Analyse de texte'],
        # ['Traducteur', 'Traduit ce texte en 1. anglais, 2. espagnol, et 3. portugais : [entrer un texte]', 'Traduction'],
        ['Résumer un texte', 'Résume ce texte : [entrer un texte]', 'Analyse de texte'],
        ['Utiliser un pronom différent', 'Ecrit un texte à propos des caves à vins en utilisant le pronom "je"', 'Génération de contenu'],
        ['Classer des mots-clés en différentes catégories/Regrouper les mots-clés en clusters thématiques', 'Classer les mots-clés suivants en 3 catégories : cave, vin, température, humidité, Ma Cave à Vin, blog, passion, etc.', 'Analyse de texte'],
        ['Générer une étude mots-clés', 'Génère une étude mots-clés sur les caves à vin de vieillissement', 'Analyse de données'],
        ['Améliorer la précision, la qualité et la longueur des réponses', 'Rajouter "Lets think step by step" à la fin du message', 'Génération de contenu'],
        ['Trouver des questions sur un sujet', 'Liste les 10 principales questions que se pose le grand public à propos des caves à vin de vieillissement', 'Recherche de questions'],
        ['Trouver des sujets à aborder pour une thématique', 'Donne moi les principaux sujets à propos des caves à vin de vieillissement pour le grand public', 'Recherche de sujets'],
        ['Lister des arguments/avantages/inconvénients', 'Cite moi les avantages et inconvénients des caves à vin de vieillissement', 'Analyse de contenu'],
...
action_selector = st.multiselect("Choisissez une action", df_examples['Type'].unique())
